import{o as n,b4 as e,e as o,h as p}from"./vendor-CKOI4o9H.js";const r={id:"basic-tinymce"},g={__name:"test",setup(a){const t={selector:"#basic-tinymce",license_key:"gpl",height:400,width:"100%",promotion:!1,branding:!1,language:"zh_CN",toolbar_mode:"wrap",plugins:"preview indent2em importcss searchreplace autolink autosave save directionality code visualblocks visualchars fullscreen image link media codesample table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars emoticons accordion",menubar:"file edit view insert format tools help",toolbar:"undo redo | styleselect formatselect fontselect fontsizeselect removeformat | blocks fontfamily fontsize | bold italic underline strikethrough subscript superscript hr blockquote | forecolor backcolor | align numlist bullist | link image media | table | lineheight indent2em outdent indent | charmap emoticons | accordion accordionremove | code codesample | fullscreen preview | save print | pagebreak anchor  | ltr rtl",font_size_formats:"12px 14px 16px 18px 24px 36px 48px 56px 72px",font_family_formats:"默认字体=Helvetica,sans-serif;微软雅黑=Microsoft YaHei,PingFang SC,sans-serif;苹果苹方=PingFang SC,Microsoft YaHei,sans-serif;宋体=simsun,serif;仿宋体=FangSong,serif;黑体=SimHei,sans-serif;Arial=arial,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Impact=impact,chicago; Symbol=symbol; Tahoma=tahoma,arial,helvetica,sans-serif; Terminal=terminal,monaco; Times New Roman=times new roman,times; Trebuchet MS=trebuchet ms,geneva; Verdana=verdana,geneva; Webdings=webdings; Wingdings=wingdings,zapf dingbats",importcss_append:!0,quickbars_selection_toolbar:"fontsize forecolor backcolor | bold italic underline | quicklink h2 h3",quickbars_insert_toolbar:!1,noneditable_class:"mceNonEditable",content_style:"body { font-family:Helvetica,Arial,sans-serif; font-size:14px }",setup:s=>{s.on("init",()=>{s.setContent(`<h3 style="margin: 0px; padding: 0px; font-size: 14px; font-weight: normal; color: rgb(51, 51, 51); font-family: Tahoma, Arial, 微软雅黑, sans-serif; line-height: 26px;">
    ...
    <p>
        &nbsp;
    </p >`)}),s.on("Change KeyUp",()=>{})}};return n(()=>{e.init(t)}),(s,i)=>(o(),p("div",r,"大发发"))}};export{g as default};
